...
/**
 * UpdateOtpActionRequestDTO
 */

public class UpdateOtpActionRequestDTO {
   ...
   * @return The modified UpdateOtpActionRequestDTO instance
   */
  public UpdateOtpActionRequestDTO otpType(OTPType otpType) {
  ...
  public UpdateOtpActionRequestDTO createdAt(OffsetDateTime createdAt) {
  ...
  public UpdateOtpActionRequestDTO updatedAt(OffsetDateTime updatedAt) {
   ...
   * @return The modified UpdateOtpActionRequestDTO instance
   */
  public UpdateOtpActionRequestDTO otpFormat(OTPFormat otpFormat) {
   ...
   * @return The modified UpdateOtpActionRequestDTO instance
   */
  public UpdateOtpActionRequestDTO authorizedMethods(Set<Method> authorizedMethods) {
   ...
   * @return The modified UpdateOtpActionRequestDTO instance
   */
  public UpdateOtpActionRequestDTO duration(Integer duration) {
   ...
   * @return The modified UpdateOtpActionRequestDTO instance
   */
  public UpdateOtpActionRequestDTO templates(Map<Method, Object> templates) {
   ...
   * @return The modified UpdateOtpActionRequestDTO instance
   */
  public UpdateOtpActionRequestDTO maxAttempts(Map<Method, Integer> maxAttempts) {
