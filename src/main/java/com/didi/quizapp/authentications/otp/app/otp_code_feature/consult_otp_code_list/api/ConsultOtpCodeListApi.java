package com.didi.quizapp.authentications.otp.app.otp_code_feature.consult_otp_code_list.api;
...
@Validated
@Tag(name = "ConsultOtpCodeList", description = "Endpoint feature to consult otp codes list")
public interface ConsultOtpCodeListApi {

        /**
         * GET /iam/authentications/otp/otp-codes : Consult OtpCode List
         * Consult the list of otp codes paginated.
         *
         ...
         */
        @Operation(operationId = "consultOtpCodeList", summary = "Consult OtpCode List", description = "Consult the list of otp codes paginated.", tags = {
                        "ConsultOtpCodeList" }, responses = {
                                        @ApiResponse(responseCode = "200", description = "Returned when everything works well", content = {
                                                        @Content(mediaType = "application/json", schema = @Schema(implementation = ConsultOtpCodeListResponseDTO.class))
                                        }),
                                        @ApiResponse(responseCode = "default", description = "Returned when an error occur", content = {
                                                        @Content(mediaType = "application/json", schema = @Schema(implementation = ResponseErrorDTO.class))
                                        })
                        })
        @RequestMapping(method = RequestMethod.GET, value = "/iam/authentications/otp/otp-codes", produces = {
                        "application/json" })

        ResponseEntity<ConsultOtpCodeListResponseDTO> _consultOtpCodeList(
