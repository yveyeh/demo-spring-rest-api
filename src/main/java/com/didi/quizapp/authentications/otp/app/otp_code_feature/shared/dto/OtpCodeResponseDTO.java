package com.didi.quizapp.authentications.otp.app.otp_code_feature.shared.dto;
...
public class OtpCodeResponseDTO {
  ...
  public OtpCodeResponseDTO id(UUID id) {
    this.id = id;
    return this;
  }
   ...
   */
  @Valid
  @Schema(name = "id", accessMode = Schema.AccessMode.READ_ONLY, description = "ID of the otp code", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("id")
  public UUID getId() {
    return id;
  }
  ...
  public OtpCodeResponseDTO createdAt(OffsetDateTime createdAt) {
  ...
  public OtpCodeResponseDTO updatedAt(OffsetDateTime updatedAt) {
   ...
   * @return The modified OtpCodeResponseDTO instance
   */
  public OtpCodeResponseDTO otpType(OTPType otpType) {
   ...
   * @return The modified OtpCodeOutputDTO instance
   */
  public OtpCodeResponseDTO otpFormat(OTPFormat otpFormat) {
   ...
   * @return The modified OtpCodeResponseDTO instance
   */
  public OtpCodeResponseDTO authorizedMethods(Set<Method> authorizedMethods) {
   ...
   */
  @Valid
  @Schema(name = "authorized_methods", description = "The authorized notification methods for an otp code", requiredMode = Schema.RequiredMode.REQUIRED)
   ...
   * @return The modified OtpCodeResponseDTO instance
   */
  public OtpCodeResponseDTO duration(Integer duration) {
   ...
   * @return The modified OtpCodeResponseDTO instance
   */
  public OtpCodeResponseDTO templates(Map<Method, Object> templates) {
   ...
   * @return The modified OtpCodeResponseDTO instance
   */
  public OtpCodeResponseDTO maxAttempts(Map<Method, Integer> maxAttempts) {
    this.maxAttempts = maxAttempts;
    return this;
  }

  /**
   * @return maxAttempts the max attempts allowed per method
   */
  @Valid
  ...
  private Map<Method, Integer> getMaxAttempts() {
    return maxAttempts;
  }
