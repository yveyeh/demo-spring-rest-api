...
/**
 * UpdateOtpCodeRequestDTO
 */

public class UpdateOtpCodeRequestDTO {
   ...
   * @return The modified UpdateOtpCodeRequestDTO instance
   */
  public UpdateOtpCodeRequestDTO otpType(OTPType otpType) {
  ...
  public UpdateOtpCodeRequestDTO createdAt(OffsetDateTime createdAt) {
  ...
  public UpdateOtpCodeRequestDTO updatedAt(OffsetDateTime updatedAt) {
   ...
   * @return The modified UpdateOtpCodeRequestDTO instance
   */
  public UpdateOtpCodeRequestDTO otpFormat(OTPFormat otpFormat) {
   ...
   * @return The modified UpdateOtpCodeRequestDTO instance
   */
  public UpdateOtpCodeRequestDTO authorizedMethods(Set<Method> authorizedMethods) {
   ...
   * @return The modified UpdateOtpCodeRequestDTO instance
   */
  public UpdateOtpCodeRequestDTO duration(Integer duration) {
   ...
   * @return The modified UpdateOtpCodeRequestDTO instance
   */
  public UpdateOtpCodeRequestDTO templates(Map<Method, Object> templates) {
   ...
   * @return The modified UpdateOtpCodeRequestDTO instance
   */
  public UpdateOtpCodeRequestDTO maxAttempts(Map<Method, Integer> maxAttempts) {
