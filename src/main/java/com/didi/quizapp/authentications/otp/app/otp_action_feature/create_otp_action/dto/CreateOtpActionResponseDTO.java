...
public class CreateOtpActionResponseDTO {
    ...
    public CreateOtpActionResponseDTO data(OtpActionResponseDTO data) {
        this.data = data;
        return this;
    }
    ...
    public CreateOtpActionResponseDTO metaData(MetaDataDTO metaData) {
    ...
    public CreateOtpActionResponseDTO elapsedTime(BigDecimal elapsedTime) {
