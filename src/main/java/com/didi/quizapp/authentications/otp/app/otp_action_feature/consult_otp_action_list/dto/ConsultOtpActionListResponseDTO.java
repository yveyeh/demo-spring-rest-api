package com.didi.quizapp.authentications.otp.app.otp_action_feature.consult_otp_action_list.dto;
...
public class ConsultOtpActionListResponseDTO {

    @Valid
    private List<@Valid OtpActionResponseDTO> data = new ArrayList<>();

    private MetaDataDTO metaData;

    private BigDecimal elapsedTime;

    public ConsultOtpActionListResponseDTO data(List<@Valid OtpActionResponseDTO> data) {
        this.data = data;
        return this;
    }

    public ConsultOtpActionListResponseDTO addDataItem(OtpActionResponseDTO dataItem) {
        if (this.data == null) {
    ...
    @JsonProperty("data")
    public List<@Valid OtpActionResponseDTO> getData() {
        return data;
    }

    public void setData(List<@Valid OtpActionResponseDTO> data) {
        this.data = data;
    }

    public ConsultOtpActionListResponseDTO metaData(MetaDataDTO metaData) {
    ...
    public ConsultOtpActionListResponseDTO elapsedTime(BigDecimal elapsedTime) {
