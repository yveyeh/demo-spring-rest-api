...
/**
 * UpdateOtpActionInputDTO
 */

public class UpdateOtpActionInputDTO {
     ...
     * @return The modified UpdateOtpActionInputDTO instance
     */
    public UpdateOtpActionInputDTO otpType(OTPType otpType) {
    ...
    public UpdateOtpActionInputDTO createdAt(OffsetDateTime createdAt) {
    ...
    public UpdateOtpActionInputDTO updatedAt(OffsetDateTime updatedAt) {
     ...
     * @return The modified UpdateOtpActionInputDTO instance
     */
    public UpdateOtpActionInputDTO otpFormat(OTPFormat otpFormat) {
     ...
     * @return The modified UpdateOtpActionInputDTO instance
     */
    public UpdateOtpActionInputDTO authorizedMethods(Set<Method> authorizedMethods) {
     ...
     * @return The modified UpdateOtpActionInputDTO instance
     */
    public UpdateOtpActionInputDTO duration(Integer duration) {
     ...
     * @return The modified UpdateOtpActionInputDTO instance
     */
    public UpdateOtpActionInputDTO templates(Map<Method, Object> templates) {
     ...
     * @return The modified UpdateOtpActionInputDTO instance
     */
    public UpdateOtpActionInputDTO maxAttempts(Map<Method, Integer> maxAttempts) {
