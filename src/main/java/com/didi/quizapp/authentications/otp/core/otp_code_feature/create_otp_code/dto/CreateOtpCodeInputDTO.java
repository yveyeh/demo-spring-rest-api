...
@SuperBuilder
@NoArgsConstructor
public class CreateOtpCodeInputDTO {
    ...
    public CreateOtpCodeInputDTO updatedAt(OffsetDateTime updatedAt) {
    ...
    // public CreateOtpCodeInputDTO value(String value) {
    //     this.value = value;
    //     return this;
    // }
    ...
    // public CreateOtpCodeInputDTO expiresAt(OffsetDateTime expiresAt) {
    ...
    // public CreateOtpCodeInputDTO methods(Set<String> methods) {
    ...
    // public CreateOtpCodeInputDTO attempts(Map<String, Integer> attempts) {
    ...
    // public CreateOtpCodeInputDTO messages(Map<String, String> messages) {
    ...
    public CreateOtpCodeInputDTO recipient(String recipient) {
    ...
    public CreateOtpCodeInputDTO isInvalid(Boolean isInvalid) {
    ...
    public CreateOtpCodeInputDTO otpActionId(UUID otpActionId) {
    ...
    // public CreateOtpCodeInputDTO userId(UUID userId) {
    //     this.userId = userId;
    //     return this;
    // }
