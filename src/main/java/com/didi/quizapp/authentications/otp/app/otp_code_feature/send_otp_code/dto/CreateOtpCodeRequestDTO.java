package com.didi.quizapp.authentications.otp.app.otp_code_feature.send_otp_code.dto;
...
@SuperBuilder
@NoArgsConstructor
public class CreateOtpCodeRequestDTO {
    ...
    public CreateOtpCodeRequestDTO updatedAt(OffsetDateTime updatedAt) {
    ...
    // public CreateOtpCodeRequestDTO value(String value) {
    //     this.value = value;
    //     return this;
    // }
    ...
    // public CreateOtpCodeRequestDTO expiresAt(OffsetDateTime expiresAt) {
    ...
    // public CreateOtpCodeRequestDTO methods(Set<String> methods) {
    ...
    // public CreateOtpCodeRequestDTO attempts(Map<String, Integer> attempts) {
    ...
    // public CreateOtpCodeRequestDTO messages(Map<String, String> messages) {
    ...
    public CreateOtpCodeRequestDTO recipient(String recipient) {
    ...
    public CreateOtpCodeRequestDTO isInvalid(Boolean isInvalid) {
    ...
    public CreateOtpCodeRequestDTO otpActionId(UUID otpActionId) {
    ...
    // public CreateOtpCodeRequestDTO userId(UUID userId) {
    //     this.userId = userId;
    //     return this;
    // }
