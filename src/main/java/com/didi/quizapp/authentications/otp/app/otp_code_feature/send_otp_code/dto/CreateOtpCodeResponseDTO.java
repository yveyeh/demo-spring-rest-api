...
public class CreateOtpCodeResponseDTO {
    ...
    public CreateOtpCodeResponseDTO data(OtpCodeResponseDTO data) {
        this.data = data;
        return this;
    }
    ...
    public CreateOtpCodeResponseDTO metaData(MetaDataDTO metaData) {
    ...
    public CreateOtpCodeResponseDTO elapsedTime(BigDecimal elapsedTime) {
