...
public class CreateOtpCodeOutputDTO {
    ...
    public CreateOtpCodeOutputDTO data(OtpCodeOutputDTO data) {
        this.data = data;
        return this;
    }
    ...
    public CreateOtpCodeOutputDTO metaData(MetaDataDTO metaData) {
    ...
    public CreateOtpCodeOutputDTO elapsedTime(BigDecimal elapsedTime) {
