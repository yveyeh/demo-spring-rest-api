package com.didi.quizapp.authentications.otp.core.otp_code_feature.shared.dto;
...
public class OtpCodeOutputDTO {
    ...
    public OtpCodeOutputDTO id(UUID id) {
        this.id = id;
        return this;
    }
    ...
    public OtpCodeOutputDTO updatedAt(OffsetDateTime updatedAt) {
    ...
    public OtpCodeOutputDTO value(String value) {
        this.value = value;
        return this;
    }
    ...
    public OtpCodeOutputDTO expiresAt(OffsetDateTime expiresAt) {
    ...
    public OtpCodeOutputDTO methods(Set<String> methods) {
    ...
    public OtpCodeOutputDTO attempts(Map<String, Integer> attempts) {
    ...
    public OtpCodeOutputDTO messages(Map<String, String> messages) {
    ...
    public OtpCodeOutputDTO recipient(String recipient) {
    ...
    public OtpCodeOutputDTO isInvalid(Boolean isInvalid) {
    ...
    public OtpCodeOutputDTO otpActionId(UUID otpActionId) {
    ...
    public OtpCodeOutputDTO userId(UUID userId) {
        this.userId = userId;
        return this;
    }
