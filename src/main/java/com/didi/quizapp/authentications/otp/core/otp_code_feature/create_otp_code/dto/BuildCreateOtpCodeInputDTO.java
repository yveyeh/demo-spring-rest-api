package com.didi.quizapp.authentications.otp.core.otp_code_feature.create_otp_code.dto;
...
@SuperBuilder
@NoArgsConstructor
public class BuildCreateOtpCodeInputDTO {
    ...
    public BuildCreateOtpCodeInputDTO updatedAt(OffsetDateTime updatedAt) {
    ...
    public BuildCreateOtpCodeInputDTO value(String value) {
        this.value = value;
        return this;
    }
    ...
    public BuildCreateOtpCodeInputDTO expiresAt(OffsetDateTime expiresAt) {
    ...
    public BuildCreateOtpCodeInputDTO methods(Set<String> methods) {
    ...
    public BuildCreateOtpCodeInputDTO attempts(Map<String, Integer> attempts) {
    ...
    public BuildCreateOtpCodeInputDTO messages(Map<String, String> messages) {
    ...
    public BuildCreateOtpCodeInputDTO recipient(String recipient) {
    ...
    public BuildCreateOtpCodeInputDTO isInvalid(Boolean isInvalid) {
    ...
    public BuildCreateOtpCodeInputDTO otpActionId(UUID otpActionId) {
    ...
    public BuildCreateOtpCodeInputDTO userId(UUID userId) {
        this.userId = userId;
        return this;
    }
