package com.didi.quizapp.authentications.otp.app.otp_action_feature.shared.dto;
...
/**
 * OtpActionResponseDTO
 */

public class OtpActionResponseDTO {
  ...
  public OtpActionResponseDTO id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  public OtpActionResponseDTO createdAt(OffsetDateTime createdAt) {
  ...
  public OtpActionResponseDTO updatedAt(OffsetDateTime updatedAt) {
   ...
   * @return The modified OtpActionResponseDTO instance
   */
  public OtpActionResponseDTO otpType(OTPType otpType) {
   ...
   */
  public OtpActionResponseDTO otpFormat(OTPFormat otpFormat) {
   ...
   * @return The modified OtpActionResponseDTO instance
   */
  public OtpActionResponseDTO authorizedMethods(Set<Method> authorizedMethods) {
   ...
   * @return The modified OtpActionResponseDTO instance
   */
  public OtpActionResponseDTO duration(Integer duration) {
   ...
   * @return The modified OtpActionResponseDTO instance
   */
  public OtpActionResponseDTO templates(Map<Method, Object> templates) {
   ...
   * @return The modified OtpActionResponseDTO instance
   */
  public OtpActionResponseDTO maxAttempts(Map<Method, Integer> maxAttempts) {
