package com.didi.quizapp.authentications.otp.app.otp_code_feature.consult_otp_code_list.dto;
...
public class ConsultOtpCodeListResponseDTO {

    @Valid
    private List<@Valid OtpCodeResponseDTO> data = new ArrayList<>();

    private MetaDataDTO metaData;

    private BigDecimal elapsedTime;

    public ConsultOtpCodeListResponseDTO data(List<@Valid OtpCodeResponseDTO> data) {
        this.data = data;
        return this;
    }

    public ConsultOtpCodeListResponseDTO addDataItem(OtpCodeResponseDTO dataItem) {
        if (this.data == null) {
    ...
    @JsonProperty("data")
    public List<@Valid OtpCodeResponseDTO> getData() {
        return data;
    }

    public void setData(List<@Valid OtpCodeResponseDTO> data) {
        this.data = data;
    }

    public ConsultOtpCodeListResponseDTO metaData(MetaDataDTO metaData) {
    ...
    public ConsultOtpCodeListResponseDTO elapsedTime(BigDecimal elapsedTime) {
