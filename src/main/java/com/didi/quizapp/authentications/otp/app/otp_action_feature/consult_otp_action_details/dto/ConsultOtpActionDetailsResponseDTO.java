package com.didi.quizapp.authentications.otp.app.otp_action_feature.consult_otp_action_details.dto;
...
public class ConsultOtpActionDetailsResponseDTO {
    ...
    public ConsultOtpActionDetailsResponseDTO data(OtpActionResponseDTO data) {
        this.data = data;
        return this;
    }
    ...
    public ConsultOtpActionDetailsResponseDTO metaData(MetaDataDTO metaData) {
    ...
    public ConsultOtpActionDetailsResponseDTO elapsedTime(BigDecimal elapsedTime) {
